...
public class MockHttpClient {
	...
	public static void main(String[] args) throws Exception {
		...
		IDemoService httpService = (IDemoService) new NetComClientProxy("127.0.0.1:7070", NetComEnum.JETTY, Serializer.SerializeEnum.HESSIAN.serializer, IDemoService.class, 1000 * 5, null).getObject();
