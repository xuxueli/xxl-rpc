...
//
//		DemoService tcpService = (DemoService) new XxlRpcReferenceBean("127.0.0.1:7080", NetEnum.NETTY, Serializer.SerializeEnum.HESSIAN.serializer, DemoService.class, 1000 * 5, null).getObject();
//
