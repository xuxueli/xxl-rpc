...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			...
			<span class="logo-lg"><b>服务治理</b>中心</span>
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click" ><a href="${request.contextPath}/rpc"><i class="fa fa-circle-o text-red"></i> <span>服务管理</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
			...
			<a href="http://www.cnblogs.com/xuxueli/p/4845111.html" target="_blank" >oschina</a>
